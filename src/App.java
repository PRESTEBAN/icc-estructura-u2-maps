...
public class App {
    ...
    private static void runEjerccios() {
        ...
        System.out.println(java.util.Arrays.toString(resultadoA));
        System.out.println(java.util.Arrays.toString(resultadoB)); 
        ...
        System.out.println(ejercicios.sonAnagramas("roma", "ramo"));
    }
}
>>>>>>> 9f7fea1 (ejercicios)
